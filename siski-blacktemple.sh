...
# ============================
# Категории доменов под DPI
# ============================

# Соцсети и контент (международные)
readonly DPI_SOCIAL=(
  "youtube.com"
  "discord.com"
  "instagram.com"
...
# Торрент / пиратские ресурсы
readonly DPI_TORRENT=(
  "rutracker.org"
  "nnmclub.to"
  "flibusta.is"
  "rezka.ag"
...
# VPN / обход блокировок и сопутствующее
readonly DPI_VPN=(
  "ntc.party"
  "amnezia.org"
  "getoutline.org"
...
# Русские соцсети и платформы
readonly DPI_RUS_SOCIAL=(
  "vk.com"
  "ok.ru"
  "rutube.ru"
  "dzen.ru"
...
# Единый список DPI-блокировок (собираем категории)
...
readonly GEO_BLOCKED_SITES=(
  ...
  # AI / нейросети (часто недоступны по гео)
  "chat.openai.com"
  "platform.openai.com"
  "claude.ai"
  "poe.com"
  ...
  # крупные видеостриминги (часто гео-ограничены)
  "hbo.com"
  "hulu.com"
  "disneyplus.com"
  "paramountplus.com"
